...
const StyledButton = styled.button`
  ...
  padding: 3px;
  background: ${(props) =>
    props.background ? props.background : "rgb(195, 199, 203)"};
  margin-right: 4px;
  height: ${(props) => (props.height ? props.height + "px" : "100%")};
  color: ${(props) =>
    props.background ? "rgb(255, 255, 255)" : "rgb(0, 0, 0)"};
...
function Button({ id, children, pressed, clicked, pad, height, background }) {
  return (
    <StyledButton
      onClick={clicked}
      pressed={pressed}
